...
// only maximum score show karega//
function show_score()
{
    if (localStorage.getItem('first') == null)
    {
        ...
        window.alert("Let's start Game");
    }
    else
    {
        window.alert(" PLAYER-1 has a maximum score of " + localStorage.getItem('first').toString() + "\n" + "PLAYER-2 has a maximum score of " + localStorage.getItem('second'));
    }
}
